  ...
  return (
    ...
    >
      <div className="relative h-[185px]">
        ...
        <Image
          src={images[title] ?? "/images/home/categories/vehicles.jpg"}
          alt={title}
          fill
        ...
        <div className="absolute right-0 top-0 h-40 w-40 rounded-full bg-pink-500/25 blur-[95px] opacity-70 group-hover:opacity-100 transition" />
