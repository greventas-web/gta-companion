import GuideDatabase from "@/components/GuideDatabase";
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1700px] px-8 pt-32 pb-10">
          ...
          <p className="mt-8 max-w-3xl text-xl leading-10 text-zinc-400">
            Browse official GTA VI guides, walkthroughs, tips, and strategy
            articles to help you explore Leonida.
          </p>
